    ...
    public static function enqueue_scripts($hook) {
        ...
        wp_localize_script('dbem-admin', 'dbem_admin', array(
            ...
            'i18n'     => array(
                ...
                /* translators: %d: numero di partecipanti */
                ...
                'template_custom'  => __('(personalizzato)', 'db-event-manager'),
                'template_default' => __('(predefinito)', 'db-event-manager'),
                'qr_attachment'    => __('QR code (PNG)', 'db-event-manager'),
                'reminder_all'     => __('Invia reminder a tutti', 'db-event-manager'),
                'reminder_visible' => __('Invia reminder ai visualizzati', 'db-event-manager'),
                ...
                'field_types'      => array(
                    'text'     => __('Testo', 'db-event-manager'),
                    'email'    => __('Email', 'db-event-manager'),
                    'tel'      => __('Telefono', 'db-event-manager'),
                    'number'   => __('Numero', 'db-event-manager'),
                    'date'     => __('Data', 'db-event-manager'),
                    'textarea' => __('Area di testo', 'db-event-manager'),
                    'select'   => __('Selezione', 'db-event-manager'),
                    'radio'    => __('Scelta singola', 'db-event-manager'),
                    'checkbox' => __('Scelta multipla', 'db-event-manager'),
                ),
                'field_type'        => __('Tipo', 'db-event-manager'),
                'field_label'       => __('Etichetta', 'db-event-manager'),
                'field_required'    => __('Obbligatorio', 'db-event-manager'),
                'field_placeholder' => __('Placeholder', 'db-event-manager'),
                'field_options'     => __('Opzioni (una per riga)', 'db-event-manager'),
        ...
        if (isset($_GET['page']) && $_GET['page'] === 'dbem-checkin') { // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- parametro di navigazione in sola lettura
            ...
            wp_localize_script('dbem-checkin', 'dbem_checkin', array(
                ...
                'i18n'     => array(
                    ...
                    'scanner_missing'   => __('Libreria scanner non caricata', 'db-event-manager'),
                    'camera_denied'     => __('Impossibile accedere alla fotocamera. Verifica i permessi.', 'db-event-manager'),
                    'no_participants'   => __('Nessun iscritto', 'db-event-manager'),
                    'checkin'           => __('Segna presente', 'db-event-manager'),
                    'status_confirmed'  => __('Confermato', 'db-event-manager'),
                    'status_checked_in' => __('Presente', 'db-event-manager'),
                    'status_pending'    => __('In attesa', 'db-event-manager'),
                    'status_rejected'   => __('Rifiutato', 'db-event-manager'),
                    'status_cancelled'  => __('Annullato', 'db-event-manager'),
                ),
            ));
        }
    }
